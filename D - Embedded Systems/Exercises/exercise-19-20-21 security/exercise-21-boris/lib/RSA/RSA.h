...
/**
 * @brief This function is used to decrypt a cipher using an RSA private key.
 *
 * @param cipher The encrypted data.
...
/**
 * @brief This function is used to decrypt a cipher using an RSA public key.
 *
 * @param cipher The encrypted data.
 * @param public_key The public key.
 * @param data A buffer for the decrypted data. Size of the buffer should be at least RSA_BLOCK_SIZE.
