...
gift_list.append('olives')
print(gift_list)

# 26. Add the list ["socks", "tshirt", "pajamas"] to the end of gift_list
gift_list.append(['socks', '4K drone', 'wine', 'jam'])
print(gift_list)
